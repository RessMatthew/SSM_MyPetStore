    ...
    public List<Item> getItemListByProduct(String productId) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                item.setStatus(resultSet.getString(8));
                item.setAttribute1(resultSet.getString(9));
                item.setAttribute2(resultSet.getString(10));
                item.setAttribute3(resultSet.getString(11));
                item.setAttribute4(resultSet.getString(12));
                item.setAttribute5(resultSet.getString(13));
                itemList.add(item);
